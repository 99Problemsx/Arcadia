...
module LinCharmConfig
  ...
  # Be aware that if you activate this configuration, the full teams in the trainer PBS will be used only when
  # the Hard Charm is active.
  EXTRA_POKEMON = false
