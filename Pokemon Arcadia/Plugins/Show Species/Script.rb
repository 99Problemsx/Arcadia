#===============================================================================
# * Show Species Introduction - by FL (Credits will be appreciated)
#===============================================================================
#
# This script is for Pokémon Essentials. It shows a picture with the Pokémon
# species in a border together with a message containing the name and kind,
# plays its cry and marks it as seen in the Pokédex. Good for making the starter
# selection event.
#
#== INSTALLATION ===============================================================
#
# Put it above main OR convert it into a plugin.
#
#== HOW TO USE =================================================================
#
...
#== NOTES ======================================================================
#
# You can look and change SpeciesIntro instance attributes, directly or by
...
class SpeciesIntro
  ...
  def text_message
    ret = name
    ret += @message_complement || _INTL(". {1} Pokémon.", category)
    return ret
  end
